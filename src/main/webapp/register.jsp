	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" id="registerForm" style="margin-top: 5px;" action="${pageContext.request.contextPath}/registered" method="post" >
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
							  ...
							  <label class="error" for="sex2" style="display: none">性别必须选</label>
						</div>
					</div>
					<div class="form-group">
