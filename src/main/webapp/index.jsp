			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${NewProduct}" var="newproduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="product_info.htm">
								<img src="${pageContext.request.contextPath}/${newproduct.getPimage()}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="product_info.html" style='color:#666'>${newproduct.getPname()}</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${newproduct.getShop_price()}</font></p>
						</div>
					</c:forEach>
				</div>
			</div>			
